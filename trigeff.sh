...
#path to onia file
ONIAFILEPATH=${1:-"../rootfiles/datasets/Run3Pre_dilepton/Oniatree_MC_miniAOD_PG_Pt_0p5_3_5p02TeV_cmssw11_2_2_Run3Cond_merged.root"}
...
./PlotEff/ploteff "${OUTPUTPATH}/output.root" "${OUTPUTPATH}"